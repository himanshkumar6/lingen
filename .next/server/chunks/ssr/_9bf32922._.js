module.exports=[24651,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/tools/BlogArticle.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/tools/BlogArticle.tsx <module evaluation>","default")},20279,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/components/tools/BlogArticle.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/components/tools/BlogArticle.tsx","default")},17905,a=>{"use strict";a.i(24651);var b=a.i(20279);a.n(b)},52519,a=>{"use strict";var b=a.i(7997),c=a.i(17905);let d=[{title:"How to Write a Bio for Instagram (Complete Guide for USA Creators)",slug:"how-to-write-a-bio-for-instagram",excerpt:"Learn how to write a professional, catchy and SEO-optimized Instagram bio that attracts followers in the United States.",coverImage:"/blog/instagram-bio.png",category:"Instagram Growth",publishDate:"15 Feb 2026",readingTime:"8 min read",content:`
...
`}];async function e(){return d.map(a=>({slug:a.slug}))}async function f({params:a}){let{slug:d}=await a;return(0,b.jsx)(c.default,{})}a.s(["default",()=>f,"generateStaticParams",()=>e],52519)}];

//# sourceMappingURL=_9bf32922._.js.map