module.exports=[70943,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var a={getOrigin:function(){return s},resolveArray:function(){return r},resolveAsArrayOrUndefined:function(){return n}};for(var i in a)Object.defineProperty(o,i,{enumerable:!0,get:a[i]});function r(e){return Array.isArray(e)?e:[e]}function n(e){if(null!=e)return r(e)}function s(e){let t;if("string"==typeof e)try{t=(e=new URL(e)).origin}catch{}return t}},73853,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var a={resolveManifest:function(){return l},resolveRobots:function(){return n},resolveRouteData:function(){return u},resolveSitemap:function(){return s}};for(var i in a)Object.defineProperty(o,i,{enumerable:!0,get:a[i]});let r=e.r(70943);function n(e){let t="";for(let o of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,r.resolveArray)(o.userAgent||["*"]))t+=`User-Agent: ${e}
`;if(o.allow)for(let e of(0,r.resolveArray)(o.allow))t+=`Allow: ${e}
`;if(o.disallow)for(let e of(0,r.resolveArray)(o.disallow))t+=`Disallow: ${e}
...
`),i+="</url>\n"}return i+"</urlset>\n"}function l(e){return JSON.stringify(e)}function u(e,t){return"robots"===t?n(e):"sitemap"===t?s(e):"manifest"===t?l(e):""}},8922,e=>{"use strict";var t=e.i(47909),o=e.i(74017),a=e.i(96250),i=e.i(59756),r=e.i(61916),n=e.i(74677),s=e.i(69741),l=e.i(16795),u=e.i(87718),h=e.i(95169),d=e.i(47587),c=e.i(66012),m=e.i(70101),g=e.i(74838),p=e.i(10372),y=e.i(93695);e.i(20232);var f=e.i(220),b=e.i(89171);let v=[{title:"How to Write a Bio for Instagram (Complete Guide for USA Creators)",slug:"how-to-write-a-bio-for-instagram",excerpt:"Learn how to write a professional, catchy and SEO-optimized Instagram bio that attracts followers in the United States.",coverImage:"/blog/instagram-bio.png",category:"Instagram Growth",publishDate:"15 Feb 2026",readingTime:"8 min read",content:`
...
`}];function w(){let e="https://linkgen.in";return[...["","/instagram-bio-generator","/youtube-thumbnail-downloader","/youtube-tag-extractor","/youtube-description-extractor","/font-converter","/character-counter","/anime-name-generator","/privacy-policy","/terms","/disclaimer","/contact","/about","/blog"].map(t=>({url:`${e}${t}`,lastModified:new Date})),...v.map(t=>({url:`${e}/blog/${t.slug}`,lastModified:new Date(t.publishDate)}))]}e.s(["default",()=>w],89282);var T=e.i(73853);async function S(){let e=await w(),t=(0,T.resolveRouteData)(e,"sitemap");return new b.NextResponse(t,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}e.s(["GET",()=>S],39248),e.i(39248),e.i(89282),e.s(["GET",()=>S],21330);var k=e.i(21330);let C=new t.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap--route-entry",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/sitemap--route-entry.js",nextConfigOutput:"",userland:k}),{workAsyncStorage:I,workUnitAsyncStorage:A,serverHooks:Y}=C;function x(){return(0,a.patchFetch)({workAsyncStorage:I,workUnitAsyncStorage:A})}async function E(e,t,a){C.isDev&&(0,i.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let b="/sitemap.xml/route";b=b.replace(/\/index$/,"")||"/";let v=await C.prepare(e,t,{srcPage:b,multiZoneDraftMode:!1});if(!v)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:w,params:T,nextConfig:S,parsedUrl:k,isDraftMode:I,prerenderManifest:A,routerServerContext:Y,isOnDemandRevalidate:x,revalidateOnlyGenerated:E,resolvedPathname:R,clientReferenceManifest:O,serverActionsManifest:U}=v,M=(0,s.normalizeAppPath)(b),B=!!(A.dynamicRoutes[M]||A.routes[R]),D=async()=>((null==Y?void 0:Y.render404)?await Y.render404(e,t,k,!1):t.end("This page could not be found"),null);if(B&&!I){let e=!!A.routes[R],t=A.dynamicRoutes[M];if(t&&!1===t.fallback&&!e){if(S.experimental.adapterPath)return await D();throw new y.NoFallbackError}}let H=null;!B||C.isDev||I||(H="/index"===(H=R)?"/":H);let F=!0===C.isDev||!B,_=B&&!F;U&&O&&(0,n.setManifestsSingleton)({page:b,clientReferenceManifest:O,serverActionsManifest:U});let P=e.method||"GET",W=(0,r.getTracer)(),$=W.getActiveScopeSpan(),N={params:T,prerenderManifest:A,renderOpts:{experimental:{authInterrupts:!!S.experimental.authInterrupts},cacheComponents:!!S.cacheComponents,supportsDynamicResponse:F,incrementalCache:(0,i.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:S.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,o,a,i)=>C.onRequestError(e,t,a,i,Y)},sharedContext:{buildId:w}},q=new l.NodeNextRequest(e),L=new l.NodeNextResponse(t),j=u.NextRequestAdapter.fromNodeNextRequest(q,(0,u.signalFromNodeResponse)(t));try{let n=async e=>C.handle(j,N).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let o=W.getRootSpanAttributes();if(!o)return;if(o.get("next.span_type")!==h.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${o.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=o.get("next.route");if(a){let t=`${P} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${P} ${b}`)}),s=!!(0,i.getRequestMeta)(e,"minimalMode"),l=async i=>{var r,l;let u=async({previousCacheEntry:o})=>{try{if(!s&&x&&E&&!o)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let r=await n(i);e.fetchMetrics=N.renderOpts.fetchMetrics;let l=N.renderOpts.pendingWaitUntil;l&&a.waitUntil&&(a.waitUntil(l),l=void 0);let u=N.renderOpts.collectedTags;if(!B)return await (0,c.sendResponse)(q,L,r,N.renderOpts.pendingWaitUntil),null;{let e=await r.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(r.headers);u&&(t[p.NEXT_CACHE_TAGS_HEADER]=u),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let o=void 0!==N.renderOpts.collectedRevalidate&&!(N.renderOpts.collectedRevalidate>=p.INFINITE_CACHE)&&N.renderOpts.collectedRevalidate,a=void 0===N.renderOpts.collectedExpire||N.renderOpts.collectedExpire>=p.INFINITE_CACHE?void 0:N.renderOpts.collectedExpire;return{value:{kind:f.CachedRouteKind.APP_ROUTE,status:r.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:o,expire:a}}}}catch(t){throw(null==o?void 0:o.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:b,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:_,isOnDemandRevalidate:x})},!1,Y),t}},h=await C.handleResponse({req:e,nextConfig:S,cacheKey:H,routeKind:o.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:A,isRoutePPREnabled:!1,isOnDemandRevalidate:x,revalidateOnlyGenerated:E,responseGenerator:u,waitUntil:a.waitUntil,isMinimalMode:s});if(!B)return null;if((null==h||null==(r=h.value)?void 0:r.kind)!==f.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==h||null==(l=h.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",x?"REVALIDATED":h.isMiss?"MISS":h.isStale?"STALE":"HIT"),I&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,m.fromNodeOutgoingHttpHeaders)(h.value.headers);return s&&B||y.delete(p.NEXT_CACHE_TAGS_HEADER),!h.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,g.getCacheControlHeader)(h.cacheControl)),await (0,c.sendResponse)(q,L,new Response(h.value.body,{headers:y,status:h.value.status||200})),null};$?await l($):await W.withPropagatedContext(e.headers,()=>W.trace(h.BaseServerSpan.handleRequest,{spanName:`${P} ${b}`,kind:r.SpanKind.SERVER,attributes:{"http.method":P,"http.target":e.url}},l))}catch(t){if(t instanceof y.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:M,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:_,isOnDemandRevalidate:x})},!1,Y),B)throw t;return await (0,c.sendResponse)(q,L,new Response(null,{status:500})),null}}e.s(["handler",()=>E,"patchFetch",()=>x,"routeModule",()=>C,"serverHooks",()=>Y,"workAsyncStorage",()=>I,"workUnitAsyncStorage",()=>A],8922)}];
